...
describe('The user can delete items from storage', function() {

  test('...removeItem should find the saved word and remove it from the array', function() {
  ...
  test(`...removeItem should find the saved word and remove it from the array even if the case doesn't match`, function() {
  ...
  test(`...removeItem should not remove an item if there is no word matching what is passed in`, function() {
